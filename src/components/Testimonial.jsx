...
function Testimonial() {
  return (
    <div className="py-14 px-3 md:px-8 lg:px- xl:px-22">
        <Title title='What Our Customer Say' subtitle="Discover why discrening travelsers choose stayventure for their luxury accommdations arround the world" />
        <motion.div
