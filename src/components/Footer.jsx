...
function Footer() {
    ...
    return (
        ...
        className=' pt-8 px-6 md:px-16 lg:px-24 xl:px-32 mt-60 text-sm text-gray-500'>
            ...
            className='flex flex-wrap justify-between items-start gap-8 md:gap-6 pd-6 border-borderColor'>
                <div >
                    <motion.img 
                    initial={{opacity:0}}
                ...
                <div>
                   ...
                   <div>
                    <p className='text-base font-medium text-gray-800 uppercase'>resouces</p>
                    <ul className='mt-3 flex flex-col gap-2 text-sm'>
                        <li><a href="#">Home</a></li>
                        <li><a href="#">List of Cars</a></li>
                        <li><a href="#">Browse your Car</a></li>
