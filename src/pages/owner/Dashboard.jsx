...
function Dashboard() {
    ...
    return (
        <div className='px-4 pt-10 md:px-10 flex-1'>
                ...
                {dashboardCards.map((card, index) => (
                    <div key={index} className='flex gap-2 items-center justify-between p-4 rounded-md border border-borderColor'>
                        <div>
                            ...
                            <p className='tex-lg font-semibold'>{card.value}</p>
                        </div>
            ...
            <div className='flex flex-wrap items-start gap-6 md-8 w-full'>
                ...
                <div className='p-4 md:p-6 md-6 border border-borderColor rounded-md w-full md:max-w-xs'>
                    <h1 className='text-l font-medium'>Monthly Revenue</h1>
